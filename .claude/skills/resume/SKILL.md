...
1. Lire `docs/PLAN.md` (état et prochaines tâches) et la dernière entrée de `docs/DECISIONS.md`.
2. `git log --oneline -10` et `git status --short` pour voir ce qui a bougé depuis.
3. Ne lire `docs/CONTEXT.md` que si la tâche touche à l'architecture ou au modèle `beltContent` ; `docs/CONVENTIONS.md` seulement avant d'écrire du contenu ou du CSS.
