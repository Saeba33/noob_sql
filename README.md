...
Documentation de reprise dans `docs/` (`CONTEXT.md` : but, architecture, conventions ; `PLAN.md` : feuille de route et journal des décisions) et `CLAUDE.md` pour le travail assisté.
