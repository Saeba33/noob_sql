...
export default function BestPractices({
	...
	return (
		...
		<div className="border border-gray-300 rounded-lg bg-gray-50 p-6">
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4" style={{ gridAutoRows: 'auto auto 1fr auto auto 1fr auto' }}>
					...
					>
						...
						<div className="bg-green-50 border-l-4 border-green-500 p-3 rounded">
							<p className="text-xs text-gray-600 font-semibold mb-1 flex items-center gap-1">
								<IoMdCheckmarkCircleOutline className="w-4 h-4 text-green-600" /> À FAIRE
							</p>
						...
						<div className="bg-red-50 border-l-4 border-red-500 p-3 rounded">
							<p className="text-xs text-gray-600 font-semibold mb-1 flex items-center gap-1">
								<BiSolidErrorAlt className="w-4 h-4 text-red-600" /> À ÉVITER
							</p>
						...
						<div className="text-xs text-gray-600 italic flex items-center gap-1">
							<IoMdInformation className="w-4 h-4 text-blue-600" /> {rule.reason}
						</div>
					</div>
				))}
			</div>
		</div>			{/* Tips section (optional) */}
			{tips && tips.length > 0 && (
