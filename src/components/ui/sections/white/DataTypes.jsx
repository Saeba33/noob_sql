...
export default function DataTypes() {
	...
	const renderTypesSection = (title, rows) => {
		return (
			<div className="border border-gray-300 squircle bg-gray-50 p-6 mt-8">
				<h5 className="font-bold text-gray-800 mb-6 flex items-center">
				...
				<div className="bg-white border border-gray-300 squircle shadow-sm overflow-hidden">
					<div className="relative">
						{/* Scroll indicator - affiché uniquement si scroll */}
						{scrollIndicator1.hasScroll && (
							<div className="scroll-indicator-white" />
						)}
						<div ref={scrollIndicator1.ref} className="overflow-x-auto">
							<table className="w-full min-w-[800px] border-collapse bg-white squircle shadow-sm overflow-hidden">
								<thead>
									<tr>
										<th className="text-xs font-semibold text-gray-600 uppercase p-3 pl-4 text-left border-b  border-r border-gray-300 bg-gray-100 ">
											Type
										</th>
										...
										<th className="text-xs font-semibold text-gray-600 uppercase p-3 text-left border-b border-gray-300 bg-gray-100 ">
											Utilisation
										</th>
									</tr>
								</thead>
									...
									{rows.map((type, typeIndex) => {
										...
										return (
											...
											>
												...
												>
													<div className="bg-gray-100 px-2 py-1 squircle-sm inline-block">
												...
												<td className={`p-3 border-r border-gray-300`}>
													<span
														className={`inline-flex items-center text-xs ${type.categoryTagColorClass} px-2 py-0.5 squircle-sm border`}
													>
														<span className="mr-1">
												...
												<td className="p-3">
													<div className="flex flex-wrap gap-1 border-gray-300">
														{type.examples.map((example, exampleIndex) => (
															<code
																key={exampleIndex}
																className="bg-gray-100 px-1 py-0.5 squircle-sm text-xs text-gray-800"
															>
																{example}
															</code>
														))}
	...
	const renderConstraintsSection = () => {
		return (
			<div className="mt-8">
				<div className="border border-gray-300 squircle bg-gray-50 p-6">
					<h5 className="font-bold text-gray-800 mb-6 flex items-center">
					...
					<div className="grid md:grid-cols-2 gap-4">
						{constraints.map((constraint, index) => (
							<div
								key={index}
								className="bg-white border border-gray-200 squircle p-4 shadow-sm"
							>
								<div className="flex items-center space-x-3">
									<div className="flex-1 self-start">
										<div className="flex items-center gap-2">
											...
											<span className="pb-1 w-5 h-5 min-w-[20px] text-gray-600 ">
												{constraint.icon}
											</span>
										</div>
										...
										<div className="inline-block bg-gray-100 border border-gray-200 squircle-sm px-2 py-1 mb-2 max-w-full">
										...
										{exampleTypes.map((row, index) => {
											...
											return (
												...
												>
													...
													<td className={`p-3 border-r border-gray-300`}>
														<code className="bg-blue-100 px-2 py-1 squircle-sm text-blue-800 text-xs">
															{row.type}
														</code>
													</td>
													<td
													...
													<td className="p-3">
														<code className="bg-gray-100 px-2 py-1 squircle-sm text-gray-800 text-xs">
															{row.example}
														</code>
													</td>
													<td
