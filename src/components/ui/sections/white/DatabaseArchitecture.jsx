			...
			<div className="mx-auto">
				...
				<div className="mt-8 p-4 bg-white border border-gray-300 rounded-lg shadow-sm">
					...
					<p className="text-gray-800 leading-relaxed mb-3">
						Les clés étrangères (<strong>FOREIGN KEY</strong>) créent des liens
						entre les tables. Dans notre exemple :
					</p>
					<ul className="text-gray-800 mb-4 space-y-1">
						<li>
							• <strong>utilisateur_id</strong> dans la table "emprunts" fait
							référence à<strong> id</strong> dans la table "utilisateurs".
						</li>
						<li>
							• <strong>livre_id</strong> dans la table "emprunts" fait
							référence à<strong> id</strong> dans la table "livres".
						</li>
					</ul>
					<div className="bg-gray-50 border border-gray-200 p-4 rounded-lg">
						<p className="text-gray-800 text-sm">
							En regardant la première ligne de la table "emprunts" (id 201), on
							peut voir que :
							<br />• <strong>utilisateur_id = 1</strong> → ce qui correspond à{" "}
							...
							<br />
							<br />
							Ainsi, on sait que Marie Dubois a emprunté "Le Petit Prince" le 10
							janvier 2025 et l'a rendu le 24 janvier.
						</p>
					</div>
				</div>
			</div>
