...
WHERE s.total_depense > 500;`,
          sqlResult: [
            { nom: "Alice Dupont", nb_commandes: 1, total_depense: 1299, panier_moyen: 1299.0 },
            { nom: "David Moreau", nb_commandes: 1, total_depense: 799, panier_moyen: 799.0 }
          ]
        },
        {
...
ORDER BY niveau, nom;`,
          sqlResult: [
            ...
            { nom: "Claire Durand", niveau: 3, nom_indente: "    Claire Durand" },
...
SELECT 'admin' AS type, nom, email_admin FROM administrateurs;`,
          sqlResult: [
            { type: "utilisateur", nom: "Alice Dupont", email: "alice@email.com" },
            { type: "utilisateur", nom: "Bob Martin", email: "bob@email.com" },
            { type: "utilisateur", nom: "Claire Durand", email: "claire@email.com" },
            { type: "utilisateur", nom: "David Moreau", email: "david@email.com" },
            { type: "utilisateur", nom: "Emma Bernard", email: "emma@email.com" },
            { type: "admin", nom: "Admin Système", email: "admin@entreprise.com" },
            { type: "admin", nom: "Super Admin", email: "superadmin@entreprise.com" }
          ]
        },
        {
...
ORDER BY age DESC;`,
          sqlResult: [
            { nom: "David Moreau", email: "david@email.com", age: 45, ville: "Lyon" },
            { nom: "Bob Martin", email: "bob@email.com", age: 32, ville: "Paris" },
            { nom: "Alice Dupont", email: "alice@email.com", age: 28, ville: "Paris" },
            { nom: "Claire Durand", email: "claire@email.com", age: 25, ville: "Lyon" }
          ]
        }
      ],
      description:
          ...
          sqlResult: [
            {
              ...
              order: 0,
              from: 0,
              detail: "SEARCH utilisateurs USING INDEX idx_utilisateurs_email (email=?)"
            }
          ]
        }
      ],
...
COMMIT;`,
          sqlResult: {
            message: "Transaction validée : utilisateur et commande créés avec succès",
            type: "message"
          }
        },
        {
...
COMMIT;`,
          sqlResult: {
            message: "Transaction validée : transfert de 200€ effectué avec succès",
            type: "message"
          }
        },
        {
